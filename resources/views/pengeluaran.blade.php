...
<div class="container py-5">
        ...
        <div class="row">
            ...
            <form action="/admin/cari" method="get" class="ml-5 col-md-6 mx-auto">
                <div class="input-group">
                    <input type="search" class="form-control rounded" name="q" value="{{ old('q') }}"
                        placeholder="Cari Barang..." aria-label="Search" aria-describedby="search-addon" required />
                    <button type="submit" class="btn btn-outline-success"><i class="fa fa-search"></i> Cari</button>
                </div>
            </form>
            <a href="#"><button class="btn btn-dark text-light ml-auto mr-2" data-toggle="modal" data-target="#tambah_katalog"><i
                    class="fa fa-sign-out text-light"></i> Pengeluaran</button></a>
                    <a href="/laporan"><button class="btn btn-dark text-light ml-auto"><i
                        class="fa fa-calendar text-light"></i> Laporan</button></a>
    ...
    <div class="row pb-5 mb-4">
            ...
            <tbody>
                @foreach ($katalog as $data)
                    <tr class="text-center">
                        ...
                        <td>{{ $data->deskripsi_katalog }}</td>
                        <td><img src="{{ asset('images/'.$data->foto_katalog)}}" style="width: 50%;height: 10%"></td>
                        <td class="row">                            
                                <a class="btn btn-dark col-md text-light" data-toggle="modal"
                                        data-target="#edit_katalog{{ $data->id_katalog }}"><i
                                            class="fa fa-pencil text-success"></i> Edit</a>
                                <a class="btn btn-danger col-md text-light"
                                        href="/katalog/hapus/{{ $data->id_katalog }}"><i class="fa fa-trash"></i>
                                        Hapus</a>
                        </td>
                    </tr>
                @endforeach
        ...
        <div class="modal fade" id="edit_katalog{{ $data->id_katalog }}" tabindex="-1" role="dialog"
                        ...
                        <form action="/katalog/edit" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input class="form-control @error('nama_katalog') is-invalid @enderror" type="text"
                                        value="{{ $data->nama_katalog }}" name="nama_katalog" id="nama_katalog"
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" value="{{ $data->harga_katalog }}" class="form-control"
                                        id="harga_katalog" name="harga_katalog" placeholder="Harga">
                                </div>
                                <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <textarea type="text" rows="3" class="form-control" id="deskripsi"
                                        name="deskripsi_katalog"
                                        placeholder="Deskripsi Katalog">{{ $data->deskripsi_katalog }}</textarea>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="gambar">Foto</label>
                                    <input type="file" accept=".jpg,.png" class="form-control-file" name="gambar"
                                        id="gambar">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="stok">Stok</label>
                                    <input type="text" name="stok_katalog" class="form-control"
                                        value="{{ $data->stok_katalog }}" min="0" max="100">
                                </div>
                            </div>
                            <div class="modal-footer">
                                <button type="submit" class="btn btn-success" name="btn-tambah"><i
                                        class="fa fa-plus"></i> Tambahkan</button>
                        </form>
...
<div class="modal fade" id="tambah_katalog" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header bg-dark">
            ...
            <div class="modal-body">
                <form action="/katalog/add" method="post" enctype="multipart/form-data">
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label for="harga">Induk Barang</label>
                            <select class="form-control" name="jenis_katalog" id="jenis_katalog">
                                <option value="baju">Helm Honda Classic</option>
                                <option value="celana">Celana</option>
                            </select>
                        </div>
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control @error('nama_katalog') is-invalid @enderror" type="text"
                                name="nama_katalog" id="nama_katalog" value="Helm Honda Classic">
                            @error('nama_katalog')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>                        
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="stok_katalog" class="form-control" value="A101" min="0" max="100">
                        </div> 
                        <div class="form-group col-md-12">
                            <label for="deskripsi">Keterangan Barang</label>
                            <textarea type="text" rows="3" class="form-control" id="deskripsi"
                                name="deskripsi_katalog" placeholder="Keterangan Barang"></textarea>
                        </div>                        
                        <div class="form-group col-md-6">
                            <label for="stok">Tanggal Keluar</label>
                            <input type="date" name="stok_katalog" class="form-control" value="10" min="0" max="100">
                        </div>
                        <div class="form-group col-md-6">
                            <label for="stok">Jumlah</label>
                            <input type="text" name="stok_katalog" class="form-control" value="1" min="0" max="100">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-success" name="btn-tambah"><i class="fa fa-save"></i>
                            Simpan</button>
                </form>
                <button type="button" class="btn btn-danger" name="btn-hapus" data-dismiss="modal"><i
                        class=""></i> Batal</button>
            ...
            <div class="">
                ...
                @foreach ($wa as $data)
                    ...
                    <div class="mx-auto d-flex justify-content-center">
                        ...
                        <a href="https://wa.me/62{{ $data->no_wa }}?text=test"
                            class="btn btn-dark col-md-3 mr-2 ml-2" target="_blank"><i class="fa fa-recycle"></i>
                            Coba</a>
                    </div>
                @endforeach
            </div>
